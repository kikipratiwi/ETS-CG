...
int main() {
	...
	// for DRAW ROTATE SQUARE ANIMATION
	POINT CENTER;
	CENTER.x = HALFWIDTH;
	CENTER.y = HALFHEIGHT;
		
	// for DRAW POINT CIRCLE ROTATE ANIMATION
	POINT rotate_point[4];
	
	// for ANIMATIE FINAL PATTERN
	...
	/* =========================================CIRCLE ANIMATION============================================== */
		// // put center point
		// filled_circle_bresenham(HALFWIDTH, HALFHEIGHT, 2, CREAM); delay(DELAY2);
		// // draw center circle
		...
		// // put center point
		// filled_circle_bresenham(HALFWIDTH, HALFHEIGHT, 2, LIGHTCLAY); delay(DELAY2);
	
		// // put 1st point
		// filled_circle_bresenham(circle_center_point[0].x, circle_center_point[0].y, 2, LIGHTCLAY); delay(DELAY2);
		// // draw 1st circle
		...
		// // put 2nd point
		// filled_circle_bresenham(circle_center_point[1].x, circle_center_point[1].y, 2, LIGHTCLAY); delay(DELAY2);
		...
		// // put 3rd point
		// filled_circle_bresenham(circle_center_point[2].x, circle_center_point[2].y, 2, LIGHTCLAY); delay(DELAY2);
		// // remove connected line
		...
		// // put 4th point
		// filled_circle_bresenham(circle_center_point[3].x, circle_center_point[3].y, 2, LIGHTCLAY); delay(DELAY2);
		// // remove connected line
...
/* ==================================================DRAW INITIATE PATTERN===================================================== */
		...
		// draw center point
		delay(DELAY200);	filled_circle_bresenham(CENTER.x, CENTER.y, 2, LIGHTCLAY);
...
/* ==================================================ANIMATIE FINAL PATTERN===================================================== */
	    // scale used as object radius
		scale = 100; // initiate scale
	    inc_scale = scale; // increment scale
		speed = 6;
		inc_rotate = 0; // increment rotate
